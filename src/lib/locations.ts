...
// Türkiye'nin 81 ili ve tüm ilçeleri.
...
export const PROVINCES: Province[] = [
  ...
  { name: "Karaman", districts: ["Ayrancı", "Başyayla", "Ermenek", "Kâzımkarabekir", "Merkez", "Sarıveliler"] },
  ...
  { name: "Samsun", districts: ["Alaçam", "Asarcık", "Atakum", "Ayvacık", "Bafra", "Canik", "Çarşamba", "Havza", "İlkadım", "Kavak", "Ladik", "19 Mayıs", "Salıpazarı", "Tekkeköy", "Terme", "Vezirköprü", "Yakakent"] },
  ...
  { name: "Sivas", districts: ["Akıncılar", "Altınyayla", "Divriği", "Doğanşar", "Gemerek", "Gürün", "Hafik", "İmranlı", "Kangal", "Koyulhisar", "Merkez", "Suşehri", "Şarkışla", "Ulaş", "Yıldızeli", "Zara"] },
...
export const PROVINCE_NAMES = PROVINCES.map((p) => p.name).sort((a, b) =>
